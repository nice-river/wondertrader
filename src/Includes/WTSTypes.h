...
NS_WTP_BEGIN
    ...
    */
    ...
    typedef enum tagOrderState {
        WOS_AllTraded = '0',
        //全部成交
        WOS_PartTraded_Queuing,
        //部分成交,仍在队列中
        WOS_PartTraded_NotQueuing,
        //部分成交,未在队列
        WOS_NotTraded_Queuing,
        //未成交
        WOS_NotTraded_NotQueuing,
        //未成交,未在队列
        WOS_Canceled,
        //已撤销
        WOS_Submitting = 'a',
...
template<>
struct fmt::formatter<wtp::WTSKlinePeriod> : fmt::formatter<std::string_view> {
    // parse is inherited from formatter<string_view>.
    auto format(wtp::WTSKlinePeriod c, format_context &ctx) const {
        using std::string_view;
        string_view name = "unknown";
        switch (c) {
            case wtp::WTSKlinePeriod::KP_Tick: name = "0";
                break;
            case wtp::WTSKlinePeriod::KP_Minute1: name = "1";
                break;
            case wtp::WTSKlinePeriod::KP_Minute5: name = "2";
                break;
            case wtp::WTSKlinePeriod::KP_DAY: name = "3";
                break;
            case wtp::WTSKlinePeriod::KP_Week: name = "4";
                break;
            case wtp::WTSKlinePeriod::KP_Month: name = "5";
                break;
        }
...
template<>
struct fmt::formatter<wtp::WTSDirectionType> : fmt::formatter<std::string_view> {
    // parse is inherited from formatter<string_view>.
    auto format(wtp::WTSDirectionType c, format_context &ctx) const {
        using std::string_view;
        string_view name = "unknown";
        switch (c) {
            case wtp::WTSDirectionType::WDT_LONG: name = "0";
                break;
            case wtp::WTSDirectionType::WDT_SHORT: name = "1";
                break;
            case wtp::WTSDirectionType::WDT_NET: name = "2";
                break;
        }
        return fmt::formatter<string_view>::format(name, ctx);
    }
